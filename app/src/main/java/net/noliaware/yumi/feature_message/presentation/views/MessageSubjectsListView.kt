...
import net.noliaware.yumi.feature_message.presentation.views.MessageSubjectItemView.MessageSubjectItemViewAdapter
...
class MessageSubjectsListView @JvmOverloads constructor(
    ...
    private val messageSubjectAdapters = mutableListOf<MessageSubjectItemViewAdapter>()
    ...
    fun fillViewWithData(adapters: List<MessageSubjectItemViewAdapter>) {
