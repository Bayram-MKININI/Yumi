...
import net.noliaware.yumi.commun.util.find
import net.noliaware.yumi.commun.util.layoutToTopLeft
import net.noliaware.yumi.commun.util.measureWrapContent
import net.noliaware.yumi.presentation.views.AccountCategoryView.AccountCategoryViewAdapter
...
class AccountItemView(context: Context, attrs: AttributeSet?) : ViewGroup(context, attrs) {
    ...
    class AccountItemViewHolder(val accountItemView: AccountItemView) : RecyclerView.ViewHolder(accountItemView)
