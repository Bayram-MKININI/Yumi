...
import net.noliaware.yumi.commun.RemoteConfig.KEY_CURRENT_VERSION
import net.noliaware.yumi.commun.RemoteConfig.KEY_FORCE_UPDATE_REQUIRED
import net.noliaware.yumi.commun.RemoteConfig.KEY_FORCE_UPDATE_URL
