...
import net.noliaware.yumi.commun.ApiParameters.DEVICE_LABEL
import net.noliaware.yumi.commun.ApiParameters.DEVICE_OS
import net.noliaware.yumi.commun.ApiParameters.DEVICE_TYPE
import net.noliaware.yumi.commun.ApiParameters.DEVICE_UUID
import net.noliaware.yumi.commun.ApiParameters.LOGIN
import net.noliaware.yumi.commun.ApiParameters.PASSWORD
import net.noliaware.yumi.commun.ApiParameters.PUSH_TOKEN
